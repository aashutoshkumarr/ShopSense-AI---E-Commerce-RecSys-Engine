    ...
    <div id="support-modal-backdrop" className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-fadeIn">
      ...
      >
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 p-4 bg-slate-100/70 border-b border-slate-200">
          ...
          <button
            id="quick-action-concierge-assistant"
            onClick={() => {
              onClose();
              onOpenConciergeHelp();
            }}
          ...
          >
            ...
            <div>
              <div className="text-xs font-bold text-slate-900">Live Concierge</div>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-slate-500">Track and respond to live tickets with our dedicated support engineers.</p>
                </div>
                <button
                    ...
                    <>
                      ...
                      <div className="flex-1 overflow-y-auto space-y-3 pr-2 mb-3">
                        {activeTicket.messages.map(m => {
                          ...
                          const isBot = m.sender === 'automated_assistant';
                          return (
                            <div
                              key={m.id}
                            ...
                            >
                              <div className="flex items-center gap-1 text-[10px] text-slate-400 mb-0.5">
                                ...
                                {isBot && <span className="text-indigo-600 font-semibold">• Automated Triage</span>}
                              </div>
