...
export const ArchitectureDiagram: React.FC = () => {
  return (
    <div className="space-y-8 max-w-7xl mx-auto px-4 py-6 text-slate-100">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h1 className="text-xl font-bold text-white">
              AI E-Commerce Recommendation Engine Architecture
            </h1>
            <p className="text-xs text-slate-400 mt-0.5">
              Production blueprint: Multi-stage online serving, decoupled LLM natural language understanding, and separate offline ML pipeline.
            </p>
          </div>
        </div>
      </div>
      ...
      {/* 3-Column Architecture Split: Online Serving vs Offline ML vs LLM Intent Layer */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        {/* Column 3: Where the AI/LLM Fits (Decoupled Intent Layer) */}
        <div className="bg-slate-900/90 rounded-2xl border border-slate-800 p-5 shadow-xl space-y-4">
          <div className="flex items-center gap-2 pb-3 border-b border-slate-800">
            <Bot className="h-5 w-5 text-amber-400" />
            <div>
              <h3 className="text-sm font-bold text-white">3. Decoupled AI/LLM Intent Layer</h3>
          ...
          <div className="space-y-3 text-xs">
            ...
            <div className="p-3.5 rounded-xl bg-slate-950 border border-indigo-900/50">
              <span className="font-bold text-indigo-300 block">LLM Parsing (Gemini 3.1 Pro / 3.5 Flash)</span>
  ...
  "useCase": "software_dev"
      ...
      <div className="bg-slate-900/90 rounded-2xl border border-slate-800 p-6 shadow-xl space-y-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 text-xs">
          ...
          <div className="p-3 rounded-xl bg-slate-950 border border-slate-800">
            <span className="text-[10px] font-mono text-pink-400 uppercase block font-semibold">AI & Intent</span>
            <div className="font-medium text-slate-200 mt-1">Gemini 3.1 Pro</div>
            <div className="text-[10px] text-slate-500">High Thinking + Grounding</div>
          </div>
